...
class BinanceStreamFuturesCOINMKline(BaseModel):
    source: str = "binance"
    type: str = "kline"
...
# ✅ ORM Table
class BinanceStreamFuturesCOINMKlineTable(StreamKline):
    __tablename__ = "binance_stream_futures_coinm_kline"
...
# ✅ Mapper
class BinanceStreamFuturesCOINMKlineMapper:
    @staticmethod
    def from_raw(raw: dict) -> BinanceStreamFuturesCOINMKline:
        d = raw.get("data") or raw
        k = d.get("k") or {}

        return BinanceStreamFuturesCOINMKline(
            symbol=d["s"],
            interval=k["i"],
    ...
    @staticmethod
    def to_table(event: BinanceStreamFuturesCOINMKline) -> BinanceStreamFuturesCOINMKlineTable:
        return BinanceStreamFuturesCOINMKlineTable(
            symbol=event.symbol,
