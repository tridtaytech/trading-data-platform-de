...
args = {
    "project_id": "binance_spot_future_contract_golden_2-0823071938",
}

dag = DAG(
    "binance_spot_future_contract_golden_2-0823071938",
    default_args=args,
...
op_a58cd8df_b396_4d9e_bb16_8ed375c6eb59 = KubernetesPodOperator(
